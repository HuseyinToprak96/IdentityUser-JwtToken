...
namespace ServisLayer.Services
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public AuthenticationService(IOptions<List<Client>> optionsClient,ITokenService tokenService, UserManager<User> userManager,IUnitOfWork unitOfWork,IRepository<UserRefreshToken> UserRefreshTokenService)
        {
        ...
        public Response<ClientTokenDto> CreateTokenByClient(ClientLoginDto clientLoginDto)
        {
            ...
            if (client==null)
            {
                return Response<ClientTokenDto>.Fail("ClientId or Secret notfound",404,true);
            }
